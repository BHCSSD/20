...
## TODO
Grab the starter code form below. 
 ...
 * you should call `drawcolouredSquare()` in draw. This function should only draw 1 rect at a time.
 ...
 * make sure to use the size paramter to control the sizes of quotes
