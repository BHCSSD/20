...
function keyPressed() {
   if (key === '1' && sceneNum === 1) {
       ...
       /*--------------- Start of code to copy -------------------------------
        this is not good code, split each question off into their own function for the base level,
         or for full marks on the question portion, use parameters for each question in 1 function.*/
