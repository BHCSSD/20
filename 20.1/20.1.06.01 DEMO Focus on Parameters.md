# 20.1.06.01 DEMO Focus on Parameters
```
20.1.06.01 DEMO Focus on Parameters
```
> **Outcomes:**
...
> [!NOTE]
> ## **INFO DUMP: Adding in default Parameters**
>
...
>
> ```js
> // look something new in the parameters
...
> * the `name=human` is a default parameter that will get filled in if nothing else is passed
