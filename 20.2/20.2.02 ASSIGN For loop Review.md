...
>  let spacing= i*15// spacing is (i*15) pixels apart
>  rect(50+spacing,200,10,10)  //start at 50 and space it out.      
> }
> ```
...
function header(){
  push()
   ...
   textSize(12)
   textStyle(NORMAL)
   text("Color buttons change the line colors",210,50);
   text("Width buttons change the line widths",210,70);
...
function mousePressed() {
 ...
 // for each. you can then use hitBox() inside the loop
}
```
