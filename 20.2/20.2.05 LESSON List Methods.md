 ...
 * How to use a flag to control adding and removing items
...
function setup() {
 ...
 for (let i = 0; i < 5; i++) {
   let circleObj = { x: 50 + (i * 70), y: 200, r: 30 };
   circles.push(circleObj); // Add to end
 }
}
...
function draw() {
 ...
 for (let i = 0; i < circles.length; i++) {
   let c = circles[i]; // Get current circle
...
>
> 2. How can you make sure you only push once?
>    <details><summary>Hint</summary> We learned about it and used it in unit 1 four corners</details>
>    <details><summary>Answer</summary>Use a flag like if(isAdded=false)</details>
>
