# **20.2.11 ASSIGN Funds**
```
20.2.11 ASSIGN Funds
```
> **Outcomes:**
> 
> * **3.2 Use cohesive subprograms with helper subprograms to hide/protect data:** Building math functions that use `return` to pass data back, making sure the "calculation" part of your code is separate from the "display" part.
> * **3.3 Use environment supported data structures and their attendant operations:** Using standard arrays and built-in logic to solve a complex problem
