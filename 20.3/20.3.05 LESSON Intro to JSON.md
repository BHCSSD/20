...
* It provides a way to **structure and exchange data** between applications.
  ...
  2. **Cross-platform support**: Works with nearly all programming languages and systems.
  3. **Flexible data types**: Supports strings, numbers, arrays, objects, booleans, and null values.
  4. **Text-based**: Easy to transmit through networks like HTTP.


> [!TIP]
> In p5.js you can use JSON files to store settings, level data, sprites, or game states.
---
...
```
Each **key** MUST be a string, and each **value** can be a string, number, array, object, boolean, or null.
  ...
  ```json
  {
   "Courses": [
     ...
     },
     {
       ...
       "AKA": "Interview Preparation Course",
...
**JSON** looks almost identical to a **JavaScript object**, like this:
