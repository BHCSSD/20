...
>
> ## Text File Organization and Access
> 
>  Text files are organized as a **sequence of characters**. To separate "lines" or "chunks" of data, we use special hidden characters:
> 
> * **Newlines (`\n`):** Tells the OS to start a new line.
> * **Delimiters (`,` or `;`):** Used in CSV files to separate columns of data.
> 
> ### Accessing Text Files
> 
> Most programming languages (and the OS) treat text files as **Sequential**.
> 
> ```javascript
> // loadStrings reads the file line-by-line (sequentially)
> // and puts each line into an array.
> let poem = loadStrings("poem.txt"); 
> 
> // poem[0] is the first line
> // poem[1] is the second line
> 
> ```
> Even though we can access `poem[5]` directly in our code, the OS originally had to read the file **sequentially** from the beginning to find where that 5th line started
