# 20.3.04 LESSON Async Loading with Promises.md
```
...
## Part 3: Example: Custom Image Loader in p5.js
...
async function loadStuff() {
  ...
  loaded = true; // mark that loading is finished
}
...
function draw() {
  ...
  because the variable is already true or false.
  */
