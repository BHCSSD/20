...
| Promise State | What’s Happening                                 | Result       |
| ------------- | ------------------------------------------------ | ------------ |
| `pending`     | The image is downloading.                        | `undefined`  |
| `fulfilled`   | The image finished loading.                      | Image object |
| `rejected`    | The image couldn’t load (e.g., wrong file path). | Error object |
...
You **OULD** create your own Promise-based loader.... if you wanted to be a little too extra:
