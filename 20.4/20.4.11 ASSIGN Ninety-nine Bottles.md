...
* Write a function called `forLyrics` that holds a `for` loop that counts down from **99 to 0** and prints the lyrics.
    * See [here]([https://www.geeksforgeeks.org/python/backward-iteration-in-python/](https://sparkbyexamples.com/python/python-for-loop-in-backwards/) for how to do this.  
